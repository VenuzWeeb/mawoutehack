...
public class DiscordPresence implements Globals {
    ...
    public synchronized void start() {
        ...
        rpc.Discord_Initialize("974451701975240704", handlers, true, "");
        presence.startTimestamp = System.currentTimeMillis() / 1000L;
        presence.details = getDetails();
        presence.state = module.state.getValue();
        presence.largeImageKey = "mawo";
        presence.largeImageText = Chulohack.NAME;
        presence.smallImageKey = "mawo";
        presence.smallImageText = Chulohack.NAME;
        presence.largeImageText = Chulohack.NAME + " " + Chulohack.VERSION;
