...
public class HudEditorGui extends GuiScreen {
    ...
    private final Set<SnapPoint> snapPoints;
    private final Map<HudElement, SnapPoint> moduleSnapPoints;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (SnapPoint point : snapPoints) {
            ...
            Chulohack.getLogger().info(point.orientation.name() + " x: " + point.getX() + " y: " + point.getY() + " length: " + point.getLength());
        }
