...
public class FeetObby extends NoAttackObbyListenerModule<ListenerFeetObby> {
    ...
    protected final Setting<Boolean> antiSelfobby =
            register(new BooleanSetting("antiselfobby", true));
    ...
    public FeetObby() {
        super("FeetObby", Category.Combat);
        this.unregister(this.blockingType);
        this.setData(new FeetObbyData(this));
    }
    ...
    @Override
    protected ListenerFeetObby createListener() {
        return new ListenerFeetObby(this);
    }
